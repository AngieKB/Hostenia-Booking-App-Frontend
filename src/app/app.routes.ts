...
export const routes: Routes = [
    ...
    // Ruta por defecto (página principal - solo HUESPED o sin autenticar)
    { path: '', component: Principal, canActivate: [roleGuard], data: { expectedRole: ["HUESPED"], allowUnauthenticated: true } },
